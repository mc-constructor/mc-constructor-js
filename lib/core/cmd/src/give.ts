...
import { ClientSuccessResponse } from '@ts-mc/core/client'
import { fromEntityId, Item } from '@ts-mc/core/types'
...
class GiveCommand<TItem extends Item> extends SimpleCommandRequest<GiveResult<TItem>> {
  ...
  protected parseSuccessResponse(response: ClientSuccessResponse): GiveResult<TItem> {
