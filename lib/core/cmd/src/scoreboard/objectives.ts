...
export function addObjective(id: string, criterion: string, displayName?: TextBuilder | TextFragmentBuilder): CommandRequest {
  return new AddObjectiveCommand(id, criterion, displayName)
}

export function listObjectives(): CommandRequest {
  return new ObjectivesListCommand()
}

export function removeObjectives(...ids: string[]): CommandRequest {
  if (ids.length === 1) {
...
export function setObjectiveDisplayName(id: string, displayName: TextBuilder | TextFragmentBuilder): CommandRequest {
  return new UpdateObjectiveDisplayNameCommand(id, displayName);
}

export function setObjectiveDisplay(slot: NonTeamDisplaySlot, id: string): CommandRequest
export function setObjectiveDisplay<TSlot extends ObjectiveDisplaySlot>(display: ObjectiveDisplay, id: string): CommandRequest
export function setObjectiveDisplay<TSlot extends ObjectiveDisplaySlot>(display: ObjectiveDisplayObj<TSlot>, id: string): CommandRequest
export function setObjectiveDisplay<TSlot extends ObjectiveDisplaySlot>(slot: TSlot, teamColor: SlotTeamColor<TSlot>, id: string): CommandRequest
export function setObjectiveDisplay<TSlot extends ObjectiveDisplaySlot>(displayOrSlot: TSlot | ObjectiveDisplayObj<TSlot>, teamColorOrId: SlotTeamColor<TSlot> | string, id?: string): CommandRequest {
  return new UpdateObjectiveDisplayCommand(objectiveDisplayArgs(displayOrSlot, teamColorOrId, id))
}

export function clearObjectiveDisplay(slot: NonTeamDisplaySlot): CommandRequest
export function clearObjectiveDisplay(display: ObjectiveDisplay): CommandRequest
export function clearObjectiveDisplay<TSlot extends ObjectiveDisplaySlot>(display: ObjectiveDisplayObj<TSlot>): CommandRequest
export function clearObjectiveDisplay<TSlot extends ObjectiveDisplaySlot>(slot: TSlot, teamColor: SlotTeamColor<TSlot>): CommandRequest
export function clearObjectiveDisplay<TSlot extends ObjectiveDisplaySlot>(displayOrSlot: TSlot, teamColor?: SlotTeamColor<TSlot>): CommandRequest {
