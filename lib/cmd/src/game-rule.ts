...
export interface GameRuleCommandBuilderExplicit {
  <TRule extends GameRule>(rule: GameRule, value?: GameRuleValue[TRule]): Command
}

export interface GameRuleSubCommandBuilder<TRule extends GameRule> extends Command {
  (value?: GameRuleValue[TRule]): Command
}

export interface GameRuleBooleanCommandBuilder<TRule> extends Command {
  enable: Command
  disable: Command
}
